...
<head>
    ...
    <link href="{{asset('publisher/css/sign_in.css')}}" rel="stylesheet"/>
</head>

<body class="g-sidenav-show  bg-gray-100">
<main class="main-content mt-0 ps">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
         style="background-image: url({{asset('publisher/img/curved9.jpg')}});">
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        <form action="{{route('publisher.post.login')}}" class="text-start" method="post">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="text-center">
                                <a href="{{route('publisher.register.create')}}" class="btn bg-gradient-dark w-100 mt-2 mb-4">Đăng ký tài khoản</a>
                            </div>
                        </form>
                    </div>
                </div>
